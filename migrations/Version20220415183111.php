 ...
 */
final class Version20220415183111 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne DROP INDEX UNIQ_FCEC9EFA73F0036, ADD INDEX IDX_FCEC9EFA73F0036 (ville_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne DROP INDEX IDX_FCEC9EFA73F0036, ADD UNIQUE INDEX UNIQ_FCEC9EFA73F0036 (ville_id)');
