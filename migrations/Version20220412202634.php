 ...
 */
final class Version20220412202634 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_FCEC9EFA73F0036 ON personne (ville_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_FCEC9EF181A8BA ON personne (voiture_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_FCEC9EFA73F0036 ON personne');
        $this->addSql('DROP INDEX UNIQ_FCEC9EF181A8BA ON personne');
