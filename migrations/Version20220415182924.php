 ...
 */
final class Version20220415182924 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne DROP INDEX UNIQ_FCEC9EF181A8BA, ADD INDEX IDX_FCEC9EF181A8BA (voiture_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne DROP INDEX IDX_FCEC9EF181A8BA, ADD UNIQUE INDEX UNIQ_FCEC9EF181A8BA (voiture_id)');
