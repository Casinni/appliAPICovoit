 ...
 */
final class Version20220506083212 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX contrainte_trajet_pers ON inscription (pers_id, trajet_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP INDEX contrainte_trajet_pers ON inscription');
